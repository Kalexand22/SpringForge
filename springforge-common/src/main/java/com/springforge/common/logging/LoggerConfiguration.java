...
import com.springforge.common.ResourceUtils;
 ...
 *   <li><b>logging.level.com.springforge</b> - the logging level of given logger
 * </ul>
 *
 * <br>
...
public class LoggerConfiguration {
  ...
  private void configure() {
    ...
    // add common loggers
    logger("com.springforge", Level.INFO);
    ...
    logger("com.springforge.auth.pac4j", Level.INFO);
    ...
    if (!"OFF".equalsIgnoreCase(config.getProperty(LOGGING_PATTERN_FILE))
      ...
      rootLogger.addAppender(createFileAppender(Paths.get(logPath, "springforge.log").toString()));
    }
  }
